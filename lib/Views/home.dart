import 'package:doctorbookingapp/Data/data.dart';
import 'package:doctorbookingapp/Model/speciality.dart';
import 'package:flutter/material.dart';
import 'doctor_info.dart';

String selectedCategories = "Adult";
    ...
    return GestureDetector(
      onTap: () {
        widget.context.setState(() {
          selectedCategories = widget.categorie;
        });
      },
      child: Container(
